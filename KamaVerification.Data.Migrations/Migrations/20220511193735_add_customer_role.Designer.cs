...
namespace KamaVerification.Data.Migrations.Migrations
{
    ...
    [Migration("20220511193735_add_customer_role")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KamaVerification.Data.Models.Customer", b =>
                {
                    ...
                    b.HasIndex("PublicKey")
                        .HasDatabaseName("ix_customer_public_key");

                    b.HasIndex("RoleName")
                        .HasDatabaseName("ix_customer_role_name");
            ...
            modelBuilder.Entity("KamaVerification.Data.Models.CustomerEmailConfig", b =>
                {
                    ...
                    b.HasIndex("PublicKey")
                        .HasDatabaseName("ix_customer_email_config_public_key");

                    b.ToTable("customer_email_config", (string)null);
                });

            modelBuilder.Entity("KamaVerification.Data.Models.CustomerRole", b =>
                {
                    b.Property<string>("RoleName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasIndex("PublicKey")
                        .HasDatabaseName("ix_customer_role_public_key");
            ...
            modelBuilder.Entity("KamaVerification.Data.Models.Customer", b =>
                {
                    b.HasOne("KamaVerification.Data.Models.CustomerRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleName")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_customer_customer_roles_role_temp_id");
